...
export function GeometryToolbar(props: GeometryToolbarProps) {
  return <div className="toolbar" aria-label="几何工具栏">
    ...
    <button aria-label="添加抛物线" onClick={props.onAddParabola}>抛物线</button>
    <button aria-label="添加椭圆" onClick={props.onAddEllipse}>椭圆</button>
    <button aria-label="添加双曲线" onClick={props.onAddHyperbola}>双曲线</button>
