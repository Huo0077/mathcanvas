...
describe("ConstraintPanel", () => {
  it("shows constraint status and supports deletion", () => {
    ...
    render(<ConstraintPanel constraints={[{ id: "parallel-1", type: "parallel", targets: ["line-a", "line-b"] }]} primitives={primitives} error={null} onDelete={onDelete} />)
  ...
  it("announces a conflict with a recovery hint", () => {
    render(<ConstraintPanel constraints={[]} primitives={primitives} error="constraint solving failed to converge" onDelete={vi.fn()} />)
