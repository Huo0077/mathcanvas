...
| 阶段 | 周期 | 主要工作 | 阶段交付物 |
|---|---:|---|---|
| P0 技术验证 | 1 周 | 仓库、CI、DSL 草案、渲染 Demo | 可加载并显示最小场景 |
| P1 数学内核 | 3 周 | 表达式、点线圆、交点、DAG、撤销 | 2D 内核 v0.1 |
| P2 工作台 UI | 2 周 | GeoGebra 风格布局、工具栏、属性栏 | 可交互工作台 |
| P3 圆锥与微积分 | 3 周 | 椭圆、抛物线、导数、轨迹、滑块 | 数学工作区 MVP |
| P4 Agent 与路由 | 3 周 | Provider、健康检查、Patch、降级 | 可对话修改画布 |
| P5 题图解析 | 3 周 | OCR、视觉识别、置信度、DSL 编译 | 题图导入闭环 |
| P6 立体几何 | 4 周 | Three.js、剖切、隐藏线、折叠 | 3D 工作区 Beta |
| P7 工程制图 | 3 周 | 三视图、投影、尺寸、公差 | CAD 工作区 Beta |
| P8 稳定性发布 | 2～3 周 | 性能、安全、迁移、打包、文档 | MVP/正式版候选 |
