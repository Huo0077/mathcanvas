...
export const functionPresets: readonly FunctionPreset[] = [
  ...
  { id: "exponential", label: "Exponential", expression: "exp(x)", category: "exponential", defaultDomain: [-4, 4], helperText: "Natural exponential eˣ" },
  { id: "decay", label: "Exponential decay", expression: "exp(-x)", category: "exponential", defaultDomain: [-4, 8], helperText: "Natural exponential decay" },
